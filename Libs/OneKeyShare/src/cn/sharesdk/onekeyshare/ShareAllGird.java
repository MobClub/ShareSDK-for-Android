...
public class ShareAllGird extends Activity implements OnClickListener {
	private FrameLayout flPage; // def{note.ShareAllGird.flPage.def{lang}}
	private WeiboGridView grid; // def{note.ShareAllGird.grid.def{lang}}
	private Button btnCancel; // def{note.ShareAllGird.btnCancel.def{lang}}
	private Animation animShow; // def{note.ShareAllGird.animShow.def{lang}}
	private Animation animHide; // def{note.ShareAllGird.animHide.def{lang}}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// def{note.ShareAllGird.grid.setData.def{lang}}
		grid.setData(getIntent());
		btnCancel.setOnClickListener(this);

		// def{note.ShareAllGird.grid.show.def{lang}}
		flPage.clearAnimation();
		flPage.startAnimation(animShow);

		// def{note.ShareAllGird.logDemoEvent.1.def{lang}}
	...
	private void initPageView() {
		...
		// def{note.ShareAllGird.llPage.def{lang}}
		...
		// def{note.ShareAllGird.grid.def{lang}}
		grid = new WeiboGridView(this);
		LinearLayout.LayoutParams lpWg = new LinearLayout.LayoutParams(
				LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
		int dp_10 = cn.sharesdk.framework.res.R.dipToPx(this, 10);
		lpWg.setMargins(0, dp_10, 0, 0);
		grid.setLayoutParams(lpWg);
		llPage.addView(grid);
		
		// def{note.ShareAllGird.btnCancel.def{lang}}
		btnCancel = new Button(this);
		btnCancel.setTextColor(0xffffffff);
		btnCancel.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20);
		btnCancel.setText(R.string.cancel);
		btnCancel.setPadding(0, 0, 0, cn.sharesdk.framework.res.R.dipToPx(this, 5));
		btnCancel.setBackgroundResource(R.drawable.btn_cancel_back);
		LinearLayout.LayoutParams lpBtn = new LinearLayout.LayoutParams(
				LayoutParams.FILL_PARENT, cn.sharesdk.framework.res.R.dipToPx(this, 45));
	...
	public void finish() {
		...
		// def{note.ShareAllGird.logDemoEvent.2.def{lang}}
