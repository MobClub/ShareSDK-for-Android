...
public class FollowList extends FakeActivity implements OnClickListener, OnItemClickListener {
	...
	public void setBackPage(SharePage page) {
		this.page = page;
	}
	...
	private static class FollowAdapter extends BaseAdapter
		...
		private AbstractWeibo platform;
		private int curPage;
		...
		public void setPlatform(String name) {
			platform = AbstractWeibo.getWeibo(context, name);
			platform.setWeiboActionListener(this);
			next();
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				...
				int dp_15 = cn.sharesdk.framework.res.R.dipToPx(parent.getContext(), 15);
				int dp_10 = cn.sharesdk.framework.res.R.dipToPx(parent.getContext(), 10);
