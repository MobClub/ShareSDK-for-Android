...
版本：V2.7.5 2016-8-12
- 升级Instagram登录接口
- 优化Qzone分享，解决QQ客户端没有登录时，不能分享的问题
- 优化QQ、Qzone登录接口，没有QQ客户端时,打开网页登录
- 优化微信分享网络表情接口，解决网络gif图不能动的问题
- 优化微信分享接口，解决不能打开微信客户端的问题
- 优化微博分享接口，解决在锤子T1上分享后不能返回应用的问题
- 优化ShareSDK内部接口，减仓内存占用

以下用户建议更新：
- 调用Instagram、QQ、Qzone登录接口的用户
- 调用微信分享，关闭微信进程，不能打开微信客户端的用户
- 调用微博客户端分享，分享成功后返回到桌面的用户


版本：V2.7.4 2016-7-7
- 升级新浪微博接口，添加对新浪微博4G版本的兼容
- 优化Google+分享，添加网页分享接口（没有回调，默认回调成功）
- 优化核心库，修复X509TrustManager安全警告问题
- 优化ShareSDK，修复偶尔报没调用initSDK的异常
- 优化微信、新浪微博的图片压缩算法

以下用户建议更新：
- 2.7.3版本提示initSDK没调用的用户
- 微信分享图片在个别手机上分享失败的用户
- 提交到谷歌、UC、360等各大市场报安全警告问题的用户

版本：V2.7.3 2016-6-23
- 升级Tumblr分享接口
- 增加Facebook分享webpage类型信息
- 优化新浪分享，修复在一些手机上不能打开客户端的问题
- 优化核心库，减少内存占用
- 优化评论赞获取赞列表接口

版本：V2.7.2 2016-4-28
- 修复分享图片，后台不能正确显示分享数的问题 
- 修复公共库读取缓存错误时，分享失败的问题 
- 修复应用提交GooglePlay市场，提示X509Manager SSL安全警告问题 
- 优化核心库，减少内存占用

版本：V2.7.1 2016-4-5
- 优化Qzone分享，只支持客户端分享；删除网页分享
- 优化微博分享，修复微博客户端登录后首次分享报错的异常
- 优化QQ客户端分享，隐藏qzone分享的选项
- 优化ShareSDK内部方法，提供分享效率
- 删除蓝牙分享平台

版本：V2.7.0 2016-3-1
- 增加新版分享UI，Onkeyshare库
- 升级FacebookMessage分享接口，用客户端分享
- 优化QQ、Qzone分享接口，修复不能分享data图片的BUG
- 优化ShareSDK的初始化方法，可在多进程中调用
- 升级评论赞Socialization库,界面显示国际化
- 升级评论赞Socialization库,赞数同步和分页请求
- 升级评论赞Socialization库,楼层、评论、缓存等优化

版本：V2.6.6 2015-12-29
- 增加Qzone发说说新功能
- 优化Evernote客户端分享，多次回调的BUG
- 优化新浪客户端分享，回调白屏问题
- 优化Facebook获取用户资料时，提示需求申请权限的警告
- 优化ShareSDK核心库，减少错误警告

版本：V2.6.5 2015-11-24
- 升级Facebook分享API至2.5最新版本 
- 升级Instagram分享API，增加图文、视频分享功能
- 升级QQ分享API，增加纯图片、APP、Video分享功能
- 优化新浪微博大图片分享功能
- 优化新浪分享，回调Activity的配置
- 优化新浪客户端分享，保存草稿回调功能
- 优化ShareSDK核心库，提高分享性能

版本：V2.6.4 2015-10-30
- 修复印象笔记不能分享的BUG
- 修复人人网、Linkedin不能分享的BUG
- 修复google授权,获取用户信息的BUG
- 修复QQ、Qzone回调冲突问题
- 修复调用initSDK时，有时会报错的BUG
- 优化支付宝分享和新浪分享，使库更小，集成更加方便
- 优化ShareSDK,适配Android 6.0系统 

版本：V2.6.3 2015-9-10
- 修复腾讯微博分享失败的BUG
- 修复QQ分享、Qzone授权回调异常的BUG
- 修复集成新浪原生SDK的BUG
- 根据Android6.0,优化网络层接口
...
- 修复Onekeyshare的skyblue风格，编辑界面字数显示错误的BUG
- 优化ShareSDK的内部接口，提高分享效率

版本：V2.5.7 2015-1-4
- 优化微信6.0.2.57分享朋友圈回调接口
- 修复新浪微博在5.0系统上，不能SSO授权的bug

版本：V2.5.6 2014-12-26
- 优化微信6.0.2.56分享朋友圈没有回调的接口
- 优化ShareSDK内部接口，提高分享速度

版本：V2.5.5 2014-12-25
- 新增快捷分享九宫格的扁平化 
- 新增Google+登录，获取授权用户信息功能
- 修复有道、印象笔记分享失败的bug
- 修复QQ、Qzone获取不到用户头像的bug 
- 优化onekeyshare的自定义图片接口  
- 优化ShareSDK内部接口，提高分享效率

版本：V2.5.4 2014-12-2
- 新增Google+、短信、蓝牙、邮件 分享网络图片功能
- 新增KakaoStory、Twitter、WhatsApp 分享网络图片功能
- 新增Dropbox、Evernote、Flickr、FourSquare 分享网络图片功能
- 优化腾讯微博、VK分享本地图片接口
- 删除搜狐微博平台

版本：V2.5.3 2014-11-25
- 新增ShareSDK.deleteCache()删除缓存图片方法 
- 新增豆瓣分享网络图片功能 
- 新增removeAccount方法，取消授权 ,同时清除webview缓存 
- 新增“评论赞”点赞的外部监听接口 
- 新增微信、新浪、QQ 绕开审核时，分享私有目录图片功能 
- 新增onekeyshare的一套UI界面
- 优化ShareSDK内部接口,提升分享效率

版本：V2.5.2 2014-11-18
- 新增评论赞外部回调监听功能
- 修复评论赞调用自定义账号时，不能评论的bug
- 修复在android5.0系统上，部分平台授权出错的bug
- 删除网易微博平台
...
- 新增qq（国际版、轻聊版）的分享功能
- 新增评论赞功能（英文版）
- 修复QQ分享到电脑后，不能返回应用的bug
- 修复自定义平台（来往），调用onekeyshare时崩溃的bug 

版本：V2.4.2 2014-11-5
- 新增蓝牙分享，Pocket、FacebookMessenger、Instapaper平台 
- 新增腾讯微博分享多张图片功能 
- 新增facebook分享网络图片功能 
- 新增人人网分享链接的接口 
- 规避因4.4.x系统bug对统计数据造成的干扰 
- 修复QQ分享“我的电脑”分享成功后无法返回应用的bug 
- 修复tumblr、pocket、instagram授权重复跳转的bug 
- 修复有道分享本地图片无法显示的bug

版本：V2.4.1 2014-10-9
- 添加WhatsApp分享
- 完善人人网分享，分享后，人人网客户端可以看到分享信息
- 优化新浪获取用户信息时，获取高清头像
...
- 添加Line
- 优化快速集成工具，使之适应分包下载功能
- 修正Facebook新注册应用不能获取username的问题
- 根据腾讯官方SDK的调整，微调QQ、QQ空间和腾讯微博三个平台
...
- 放宽代码动态配置应用信息的非必要限制
- 评论与赞服务优化
- 修复微信和易信分享纯图片时，如果图片在应用私有目录下，则分享失败的问题
- 修复评论与赞盖楼显示错误的问题

版本：V2.3.7 2014-03-25
- 整合明道
- 一键分享添加截图分享功能
- 添加开发者关闭sharesdk调试日志的功能
- 评论赞添加阻止切换账号的方法
- 修正qq分享和qzone客户端分享，分享后无法获取分享结果的问题
- 修复在未授权设备上新浪微博设置ShareByAppClient="true"而不安装客户端即不能分享的问题
- 修复转短链无法关闭的bug
- 修正评论赞分享评论时显示的文本并非评论内容的问题

版本：V2.3.6 2014-03-07
- qzone提供web分享和客户端分享自行选择字段
- qzone提供web分享页面自定义功能
- 一键分享提供临时屏蔽部分平台的接口

版本：V2.3.5 2014-02-28
- 评论与赞组件添加对开发者用户系统的集成支持
